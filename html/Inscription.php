...
<body>
    ...
    <p>Veuillez remplir les champs ci-dessous pour vous inscrire à notre site.</p>
    <div class="container">
        <div class="row gy-4 gy-md-5 gy-lg-0 align-items-md-center">
            <div class="col-12 col-lg-6">
                <div class="border overflow-hidden">
                    <form action="/interact/traitement_inscription.php" method="post">
                        <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                            ...
                            <div class="col-12 col-md-6">
                                <label for="email" class="form-label">Mail <span class="text-danger">*</span></label>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="address" name="address" placeholder="67 rue du six seven">
                            </div>
                            <!--
                            <div class="col-md-6">
                            ...
                            <?php
                                if (isset($_GET['status']) && $_GET['status'] === 'success') {
                                    ...
                                    echo '<div class="alert alert-danger" role="alert">Erreur lors de l\'inscription.</div>';
                                }
                            ?>
                            <div class="col-12">
                                <div class="d-grid">
